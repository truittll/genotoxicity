...
zj48_grans=combined_stacked(list(zj48_lib7,zj48_lib8,zj48_lib11),grans8,zj48_time_points_g,20,plot_title=NULL,colors,n=c(9,9,9),"zj48_grans")+ggtitle("Granulocytes")+ylab("ZJ48 \n Percent Contribution \n of Barcodes")+theme(plot.title = element_text(size=50))
zj48_t=combined_stacked(list(zj48_lib7,zj48_lib8,zj48_lib11),t8,zj48_time_points_t,20,plot_title=NULL,colors,n=c(9,9,9),"zj48_t")+ggtitle("T Cells")+theme(plot.title = element_text(size=50))
zj48_b=combined_stacked(list(zj48_lib7,zj48_lib8,zj48_lib11),B8,zj48_time_points_b,20,plot_title=NULL,colors,n=c(9,9,9),"zj48_b")+ggtitle("B Cells")+theme(plot.title = element_text(size=50))


zj41_t=combined_stacked(list(zj41_lib7,zj41_lib8,zj41_lib11),t1,zj41_time_points_t,20,plot_title=NULL,colors,n=c(9,9,9),"zj41_t")
zj41_b=combined_stacked(list(zj41_lib7,zj41_lib8,zj41_lib11),B1,zj41_time_points_b,20,plot_title=NULL,colors,n=c(9,9,9),"zj41_b")
zj41_grans
nrow(zj41_lib7)
ncol(zj41_lib7)
...
zj41_grans=combined_stacked(list(zj41_lib7,zj41_lib8,zj41_lib11),grans1,zj41_time_points_g,20,plot_title=NULL,colors,n=c(9,9,9),"zj41_grans")+ylab("ZJ41 \n Percent Contribution \n of Barcodes")
...
create_divplot.k("idalia_MC1.txt","","lib7_K","MC")
create_divplot.k("idalia_MC2.txt","","lib8_K","MC")
create_divplot.k("idalia_MC3.txt","","lib11_K","MC")
